...
import {
  wallPieces, extentOf, DOOR_H, WALL_T, subtractRects, windowPieces, HEAD, marketSill,
} from './geometry.js';
 ...
 * @param {Array}  [opts.market]  exterior openings to frame as windows or shutter
 *   as garage doors, in model units with a `kind`; see the block below
