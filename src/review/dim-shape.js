...
// printed under COVERED DECK on the sheet, and is not a pair. Metric plans
// print the room's net area under its name ("Bedroom / 12.5 m²" -- the
// convention gridsnap's legend states, fifteenth reading), and a
// transcription may write the unit without the superscript: "m2", "ft2".
const AREA = /(sq\.?\s*ft|sq\.?\s*m|ft²|m²|ft2|m2|sqft|sqm)(?![a-z])/i;
