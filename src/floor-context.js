...
// `plans` is the home's card on the Projects page, where floors are added
// and their plans uploaded; it is reachable from every stage by nature.
const REACHABLE = {
  empty:     ['plans'],
  uploaded:  ['plans', 'review'],
  confirmed: ['plans', 'review', 'studio'],
  styled:    ['plans', 'review', 'studio', 'view3d'],
};
