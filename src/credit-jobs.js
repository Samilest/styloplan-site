...
export const FREE_KIND = {
  ...
  // ceiling is FAILED_REFUNDS_PER_ACCOUNT.
...
/**
 * FOR THE LIFE OF THE ACCOUNT, not per day. At three a day, a scripted client
 * could render, claim the render failed, take the credit back and do it
 * again -- three renders a day, every day, from one trial credit, forever
 * (Saman, 2026-09-21). At six ever, the worst case is eighteen style calls we
 * are not paid for, per account, once; a customer who really hit six gets
 * more from support. That is the price of not charging people for our own
 * defects, and it is a price we can name. See src/credit-meter.js for why a
 * ceiling has to exist at all, and supabase/free-ceiling.sql for the count.
 */
export const FAILED_REFUNDS_PER_ACCOUNT = 6;
